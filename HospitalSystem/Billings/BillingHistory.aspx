...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container w-100">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap bg-light p-3 rounded shadow-sm mb-3">
            <asp:Button ID="btnToggleVisibility" runat="server" Text="Show Full Bill" CssClass="btn btn-info"
        ...
        <div class="w-100 border shadow-sm p-3">
            <asp:Panel ID="pnlPartialBill" runat="server">
        ...
        <!-- Paid Bill Panel -->
        <div class="w-100 border shadow-sm p-3">
            <asp:Panel ID="pnlFullBill" runat="server" Visible="false">
                <telerik:RadGrid ID="RadGridFull" runat="server" AutoGenerateColumns="False" AllowPaging="True"
                    CellSpacing="-1" GridLines="Both"
                    OnNeedDataSource="RadGridFull_NeedDataSource">
                    <GroupingSettings CollapseAllTooltip="Collapse all groups" />
                    <GroupHeaderItemStyle BackColor="Red" />
                    <MasterTableView CommandItemDisplay="Top" DataKeyNames="BillingID">
                        <CommandItemSettings ShowAddNewRecordButton="False" ShowRefreshButton="False" />
