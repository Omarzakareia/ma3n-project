    ...
    <div class="container mt-4">
        ...
        <div class="w-100 p-3">
            ...
            <div class="w-100 border shadow-sm p-3">
                <!-- Full Width with Border & Shadow -->
                <telerik:RadGrid ID="RadGrid1" runat="server" AutoGenerateColumns="False" AllowPaging="True" AutoGenerateDeleteColumn="True" CellSpacing="-1" GridLines="Both" OnDeleteCommand="RadGrid1_DeleteCommand">
                    ...
                    <MasterTableView DataKeyNames="PatientID">
                        ...
                        <Columns>
                            ...
                            <telerik:GridButtonColumn CommandName="DeletePatient"
                                Text="&#10060;" HeaderText="Delete" UniqueName="DeleteColumn"
                                ButtonType="LinkButton" ItemStyle-CssClass="text-center" />
                        </Columns>
                        <EditFormSettings>
